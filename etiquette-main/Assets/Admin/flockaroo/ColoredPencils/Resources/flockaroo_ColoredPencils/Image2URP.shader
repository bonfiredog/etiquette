	...
	SubShader
	{
		...
		Pass
		{
			...
			//sampler2D _RandTex;
                        ...
                        float geomFlipY;
                        float HDRPGamma;
                        float iBufferResolutionWidth;
                        float iBufferResolutionHeight;
                        ...
                        #define GRADIENT_ENABLE
                        #define PRECALC_GRADIENT_ENABLE
                        #define FASTER
                        #define OUTLINES_ENABLE
                        #define MASK_FADE_ENABLE
                        #define SHADEROO_FRAGMENT_SHADER
                        #include "coloredpencil2.cginc"
...
#endif
                                mainImage(c,i.uv*float2(iBufferResolutionWidth,iBufferResolutionHeight));
